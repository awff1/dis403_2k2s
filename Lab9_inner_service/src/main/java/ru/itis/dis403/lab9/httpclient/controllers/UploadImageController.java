package ru.itis.dis403.lab9.httpclient.controllers;
...
import ru.itis.dis403.lab9.httpclient.service.ImageService;
import ru.itis.dis403.lab9.httpclient.service.ImageServiceForNats;
...
public class UploadImageController {
    ...
    public String showImg(Model model) {
        ...
        model.addAttribute("imgs2", imgs != null ? imgs2 : new ArrayList<String>());
        return "uploadresults";
    }
